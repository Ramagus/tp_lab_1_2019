 ...
 *
 * \return Retorna 1 (VERDADERO) si la cadena es numérica, 0 (FALSO) si no lo es y -1 en caso de error
 *
 */
 ...
 *
 * \return Retorna 0 (EXITO) si se obtiene un número entero y -1 (ERROR) si no
 *
 */
 ...
 * \param limite int Cantidad máxima de caracteres
 *
 * \return Retorna 1 (VERDADERO) si la cadena es flotante, 0 (FALSO) si no lo es y -1 en caso de error
 *
 */
 ...
 *
 * \return Retorna 0 (EXITO) si se obtiene un número flotante y -1 (ERROR) si no
 *
 */
 ...
 * \param limite int Cantidad máxima de caracteres
 *
 * \return Retorna 1 (VERDADERO) si la cadena es alfabética, 0 (FALSO) si no lo es y -1 en caso de error
 *
 */
 ...
 *
 * \return Retorna 0 (EXITO) si se obtiene una cadena alfabética y -1 (ERROR) si no
 *
 */
 ...
 * \param pResultado char* Puntero al espacio de memoria donde se dejará el resultado de la función
 *
 * \return Retorna 0 (EXITO) si se obtiene un solo caracter y -1 (ERROR) si no
 *
 */
